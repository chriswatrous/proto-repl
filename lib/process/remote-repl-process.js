...
(function() {
  ...
  module.exports = RemoteReplProcess = (function() {
    RemoteReplProcess.prototype.replView = null;

    RemoteReplProcess.prototype.conn = new NReplConnection();

    RemoteReplProcess.prototype.stopCallback = null;

    function RemoteReplProcess(replView) {
    ...
    RemoteReplProcess.prototype.start = function(connOptions) {
      this.conn.start(connOptions);
      return this.stopCallback = connOptions.stopCallback;
    };
