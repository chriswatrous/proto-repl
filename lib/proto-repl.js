...
(function() {
  ...
  module.exports = {
    ...
    prettyPrint: function() {
      return window.protoRepl.executeCode("(do (require 'clojure.pprint) (clojure.pprint/pp))");
    },
    ...
    refreshNamespaces: function(callback) {
      ...
      if (window.protoRepl.isSelfHosted()) {
        ...
        return window.protoRepl.executeCode(this.refreshNamespacesCommand, {
          displayInRepl: false,
          resultHandler: (function(_this) {
    ...
    superRefreshNamespaces: function(callback) {
      ...
      if (window.protoRepl.isSelfHosted()) {
        ...
        return window.protoRepl.executeCode("(do (when (find-ns 'clojure.tools.namespace.repl) (eval '(clojure.tools.namespace.repl/clear))) " + this.refreshNamespacesCommand + ")", {
          displayInRepl: false,
          resultHandler: (function(_this) {
            return function(result) {
              return _this.refreshResultHandler(callback, result);
    ...
    loadCurrentFile: function() {
      ...
      if (editor = atom.workspace.getActiveTextEditor()) {
        if (window.protoRepl.isSelfHosted()) {
          ...
          return window.protoRepl.executeCode("(do (println \"Loading File " + fileName + "\") (load-file \"" + fileName + "\"))");
        }
      }
    },
    ...
    runAllTests: function() {
      if (window.protoRepl.isSelfHosted()) {
        ...
        return this.refreshNamespaces((function(_this) {
          return function() {
            return window.protoRepl.executeCode("(def all-tests-future (future (time (clojure.test/run-all-tests))))");
          };
        })(this));
      }
    },
          ...
          if (window.protoRepl.isSelfHosted()) {
            ...
            parser = (function(_this) {
              return function(value) {
                return window.protoRepl.parseEdn(value).replace(/^-+\n/, '');
              };
            })(this);
          }
